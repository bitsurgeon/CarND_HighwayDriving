        ...
        if (length && length > 2 && data[0] == '4' && data[1] == '2') {
            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    // spaced at 30m interoplate these waypoints with a spline
                    // and fill it with more waypoints that control speed
                    vector<double> ptsx;
                    vector<double> ptsy;
                    ...
                    // add evenly 30m spaced points ahead of the starting
                    // reference in Frenet
                    ...
                    for (int i = 0; i < ptsx.size(); i++) {
                        // shift car reference angle to 0 degree, transformation
                        // to car's local coordinate
